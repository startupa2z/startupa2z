...
import { ArrowDown, ArrowUp, ArrowUpDown, LogOut, Search, ShieldAlert } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">{rows.length} total · click headers to sort</p>
          </div>
              ...
              {sorted.length === 0 ? (
                ...
                sorted.map((r) => (
                  <TableRow key={r.id}>
                    ...
                    <TableCell>
                      {r.linkedin_url ? (
                        <a href={r.linkedin_url} target="_blank" rel="noreferrer" className="text-primary hover:underline">
                          Profile
                        </a>
                      ) : (
