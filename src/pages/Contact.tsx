...
const faqs = [
  {
    q: "How do I join Startupa2z?",
    a: "Simply fill out the contact form on this page or attend one of our open events. We'll get you connected with the right community group.",
  },
  {
    q: "Is Startupa2z free?",
    a: "Our core community membership and most events are free. Some premium workshops and conferences may have a nominal fee.",
  },
  {
    q: "Can I list my startup in the directory?",
    a: "Yes! Submit your startup details through the contact form, selecting 'Submit a Startup' as the inquiry type. We'll review and list it within 48 hours.",
  },
  {
    q: "I'm an investor. How do I get involved?",
    a: "Register as an investor through this form. We'll connect you with our investor network and invite you to exclusive deal flow events.",
  },
  {
    q: "Do you offer mentorship for early-stage founders?",
    a: "Yes. We pair early-stage founders with experienced operators and investors from the Bay Area. Select 'Join the Community' and mention you're looking for mentorship in your message.",
  },
  {
    q: "How can my company sponsor or partner with Startupa2z?",
    a: "We work with companies on event sponsorships, ecosystem partnerships, and co-hosted programs. Reach out via the form with 'Sponsorship' or 'Partnership Inquiry' selected and our team will follow up within a few business days.",
  },
];
        ...
        <div className="container-narrow">
          ...
          >
            ...
            <p className="text-lg text-white/70 max-w-xl mx-auto">
              Have a question, partnership idea, or want to join? We'd love to
              hear from you.
            </p>
          </motion.div>
        </div>
