...
const pitchMixEvents: EventItem[] = [
  ...
  const isSeptember22WizStory = slug === "founders-pitch-mix-2026-09-22";

  return {
    slug,
    title: isSeptember22WizStory
    ...
    type: isSeptember22WizStory ? "Special Session for Founders" : "Founder Event",
    desc: isSeptember22WizStory
      ...
      ? [
          {
            name: "Daniel Slayton",
            role: "From Wiz",
            bio: "Daniel works in cybersecurity at Google and joined Wiz before it became part of Google. He also serves as a captain in the U.S. Army.",
            linkedinUrl: "https://www.linkedin.com/in/daniel-slayton/",
          },
    ...
    capacity: 0,
    price: "Free",
    featured: isSeptember22WizStory,
    imageUrl: isSeptember22WizStory
    ...
    registrationUrl: `https://luma.com/${lumaSlug}?utm_source=startupa2z&utm_medium=website&utm_campaign=${isSeptember22WizStory ? "wiz_story_sep22" : "founders_pitch_mix"}`,
