                ...
                <figure className="rounded-3xl border-2 border-primary/15 bg-card p-6 shadow-[0_14px_40px_rgba(27,75,57,0.08)] md:p-8">
                  ...
                  <div className="mt-9 px-2">
                    ...
                    <div className="mt-4 grid grid-cols-5 text-center text-xs font-semibold text-muted-foreground">
                      <span className="text-left font-bold text-secondary">{playbook.caseStudy.customerRange.minimum}</span>
                      <span>$10M</span>
                      <span>$100M</span>
                      <span>$1B</span>
                      <span className="text-right font-bold text-primary">{playbook.caseStudy.customerRange.maximum}</span>
                    </div>
                  </div>
