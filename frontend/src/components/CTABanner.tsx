...
const CTABanner = ({ title, description, primaryCTA = "Join Now", primaryLink = "/contact", secondaryCTA, secondaryLink, primaryAction }: CTABannerProps) => (
  <section className="section-padding">
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        {primaryAction === "signup" || primaryCTA === "Join Now" ? (
          <Button type="button" onClick={() => openAuthDialog("signup")} className="bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-full px-8 h-12 text-base font-semibold">
