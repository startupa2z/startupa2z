...
const september15GalleryHtml = readRoute("/gallery/founders-pitch-mix-2026-09-15");
requireText(september15GalleryHtml, 'href="https://startupa2z.org/gallery/founders-pitch-mix-2026-09-15"', "September 15 gallery canonical");
requireText(september15GalleryHtml, '"@type": "ImageGallery"', "September 15 gallery schema");
requireText(september15GalleryHtml, "4 photographs", "September 15 gallery photo count");
requireText(september15GalleryHtml, "/static/images/events/2026-09-15/event-04-01-v1.jpg", "September 15 persistent image URL");
requireText(readRoute("/events/founders-pitch-mix-2026-09-15"), "View photo gallery", "September 15 event gallery link");
...
requireText(sep15Html, "event-04-01-v1.jpg", "September 15 recap social image");
requireText(sep15Html, '"startDate": "2026-09-15T17:00:00-07:00"', "September 15 Event start date");
requireText(sep15Html, '"@type": "Article"', "September 15 recap article");
requireText(sep15Html, "Growth needs retention and unit economics", "September 15 transcript-based lesson");
requireText(sep15Html, "videotobe.com/play/collection/", "September 15 recording source");
rejectText(sep15Html, "GTM Blueprint", "September 15 avoids September 1 content");
